...
namespace SwitchPlay.Controllers
{
    public class StudioController : Controller
    {
        ...
        {
            int studioCount = _context.Studios.Count();
            return new JsonResult(studioCount);
        }
        ...
        public StudioController(IStudioService studioService, SwitchPlayContext context, IStudioCategoryService studioCategoryService, IConfiguration configuration, IFileHandleService fileHandleService, ICategoryService categoryService)
        {
